                            ...
                            <table class="table table-nowrap align-middle table-hover mb-0">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <h5 class="text-truncate font-size-14 mb-1"><a href="javascript: void(0);" class="text-dark"> Saas Dashboard</a></h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h5 class="text-truncate font-size-14 mb-1"><a href="javascript: void(0);" class="text-dark"> Crypto Dashboard</a></h5>
