    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
                <div class="d-flex">
                    <div>
                        <h4 class="card-title mb-3">Invite your friends to </h4>
                    ...
                    <div class="vstack gap-4">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="ms-2 flex-grow-1">
                                ...
                                <p class="text-muted mb-0"> Themes, Louisiana - <b>2</b> hrs ago</p>
                            </div>
                            <div class="dropdown">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="ms-2 flex-grow-1">
                                <h6 class="mb-1 font-size-15"><a href="job-details" class="text-body">Marketing Director</a></h6>
                                <p class="text-muted mb-0"> Technology, Dominica - <b>1</b> days ago</p>
                            </div>
                            <div class="dropdown">
