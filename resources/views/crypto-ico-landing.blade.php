...
<head>
    ...
    <meta charset="utf-8" />
    <title>@lang('translation.ICO_Landing') |  - Admin & Dashboard Template</title>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <div class="text-white-50">
                        <h1 class="text-white fw-semibold mb-3 hero-title"> - Ico Landing for a
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p class="mb-2">
                        ...
                        </script> © . Design & Develop by Themesbrand
                    </p>
